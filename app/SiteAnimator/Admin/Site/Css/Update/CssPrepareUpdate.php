...
class CssPrepareUpdate extends BaseClass {
    ...
    private function validateUpdatedAt( $selection, $data ) {
        ...
        // get css row
        $cssRow = SiteOptions::getOption( $this->database, $selection['id'] );
        ...
        // get date
        $date = \DateTime::createFromFormat( 'Y-m-d H:i:s', $cssRow->updated_at ); 
    ...
    private function validateName( $selection, $data ) {
        ...
        // get css name and group with other id exists
