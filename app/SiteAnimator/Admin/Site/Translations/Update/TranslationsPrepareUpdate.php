...
/*
        ...
        file:       TranslationsPrepareUpdate.php
        function:   
...
class TranslationsPrepareUpdate extends BaseClass {
    ...
    private function validateUpdatedAt( $selection, $data ) {
        ...
        $translationIdRow = Translations::getTranslationIdRow( $this->database, false, $selection['id'] );
        ...
        // get date
        $date = \DateTime::createFromFormat( 'Y-m-d H:i:s', $translationIdRow->updatedAt ); 
    ...
    private function validateName( $selection, $data ) {
        ...
        // get translation name and group with other id exists
        $nameExists = Translations::translationsWithoutIdWithGroupIdAndNameExists( $this->database, 
                                                                                   false, 
                                                                                   $selection['id'], 
                                                                                   $data['groupId'], 
                                                                                   $data['name'] );
