...
/*
        ...
        file:       TranslationsReadGroupItems.php
        function:   reads the translation rows for a group or group is null 
...
class TranslationsReadGroupItems extends BaseClass {
    ...
    private function getRows( ) {
        ...
        if( $this->groupId == null ){
            ...
            // add group to query
            $query->where( 'site_options_id', '=', $this->groupId );
