...
/*
        ...
        file:       TranslationsPrepareInsert.php
        function:   
...
class TranslationsPrepareInsert extends BaseClass {
    ...
    private function validateName( $data ) {
        ...
        // get translation name and group exists
        $nameExists = Translations::translationsWithGroupIdAndNameExists( $this->database, 
                                                                          false, 
                                                                          $data['groupId'], 
                                                                          $data['name'] );
        // get translation name and group exists
