...
class ColorsPrepareUpdate extends BaseClass {
    ...
    private function validateUpdatedAt( $selection, $data ) {
        ...
        // get color row
        $colorRow = SiteOptions::getOption( $this->database, $selection['id'] );
        ...
        // get date
        $date = \DateTime::createFromFormat( 'Y-m-d H:i:s', $colorRow->updated_at ); 
    ...
    private function validateName( $selection, $data ) {
        ...
        // get color name and group with other id exists
