...
namespace App\SiteAnimator\Admin\Site\Colors\Delete;

use App\Http\Base\BaseClass;
use App\SiteAnimator\Models\Site\SiteOptions;
use App\SiteAnimator\Models\Site\SiteOptionsDelete;
use App\SiteAnimator\Admin\Site\Colors\Delete\ColorsDelete;
...
class GroupsDelete extends BaseClass {
    ...
    public function __construct( $database, $appCode ){
        ...
        // create color delete
        $this->colorDelete = new ColorsDelete( $this->database, $this->appCode );
    ...
    private function deleteGroup( $groupId ) {
        ...
        foreach( $children as $index => $child ){
            ...
            // remove children
            $this->colorDelete->delete( array( 'id' => $child->id ) );
