...
/*
        ...
        file:       AnimationsReadGroups.php
        function:   reads the animations rows for a group or with no group  
...
class AnimationsReadGroups extends BaseClass {
    ...
    private function groupHasItems( $groupId ){
        ...
        // create group items
        $readGroupitems = new AnimationsReadGroupItems( $this->database, $this->selection );
    ...
    private function groupHasGroups( $groupId ){
        ...
        // get count
        $count = SiteOptions::getGroupCount( $this->database, $groupId, 'animationGroup' );
    ...
    private function getGroupGroups( $groupId ){
        ...
        // create group groups
        $readGroupGroups = new AnimationsReadGroups( $this->database, $this->selection );
