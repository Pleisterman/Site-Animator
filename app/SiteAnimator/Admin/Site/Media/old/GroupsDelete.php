...
class GroupsDelete extends BaseClass {
    ...
    public function __construct( $database, $appCode ){
        ...
        // create media delete
        $this->mediaDelete = new MediaDelete( $this->database, $this->appCode );
    ...
    private function deleteGroup( $groupId ) {
        ...
        // get translations
        $media = Media::getGroupMedia( $this->database, $groupId );
        
        // loop over media
        foreach( $media as $index => $child ){
            
            // remove children
            $this->mediaDelete->delete( array( 'id' => $child->id ) );
