...
/*
        ...
        file:       MediaReadGroups.php
        function:   reads the media rows for a group or with no group  
...
class MediaReadGroups extends BaseClass {
    ...
    private function groupHasItems( $groupId ){
        ...
        // create group items
        $readGroupitems = new MediaReadGroupItems( $this->appCode, $this->database, $this->selection );
    ...
    private function groupHasGroups( $groupId ){
        ...
        // get count
        $count = SiteOptions::getGroupCount( $this->database, $groupId, 'mediaGroup' );
    ...
    private function getGroupGroups( $groupId ){
        ...
        // create group groups
        $readGroupGroups = new MediaReadGroups( $this->appCode, $this->database, $this->selection );
