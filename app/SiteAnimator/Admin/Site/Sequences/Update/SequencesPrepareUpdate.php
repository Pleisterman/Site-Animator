...
/*
        ...
        file:       SequencesPrepareUpdate.php
        function:   
...
class SequencesPrepareUpdate extends BaseClass {
    ...
    private function validateUpdatedAt( $selection, $data ) {
        ...
        // get sequencs row
        $sequenceRow = SiteOptions::getOption( $this->database, $selection['id'] );
        ...
        // get date
        $date = \DateTime::createFromFormat( 'Y-m-d H:i:s', $sequenceRow->updated_at ); 
    ...
    private function validateName( $selection, $data ) {
        ...
        // get sequence name and group with other id exists
