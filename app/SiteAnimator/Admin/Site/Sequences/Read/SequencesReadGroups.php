...
/*
        ...
        file:       SequencesReadGroups.php
        function:   reads the sequence rows for a group or with no group  
...
class SequencesReadGroups extends BaseClass {
    ...
    private function groupHasItems( $groupId ){
        ...
        // create group items
        $readGroupitems = new SequencesReadGroupItems( $this->database, $this->selection );
    ...
    private function groupHasGroups( $groupId ){
        ...
        // get count
        $count = SiteOptions::getGroupCount( $this->database, $groupId, 'sequenceGroup' );
    ...
    private function getGroupGroups( $groupId ){
        ...
        // create group groups
        $readGroupGroups = new SequencesReadGroups( $this->database, $this->selection );
